...
class ChatConsumer(JsonWebsocketConsumer):
    ...
    def connect(self):
        ...
        # Assign the group "hi", the first room will be displayed when you enter
    ...
    def receive_json(self, data_received):
        ...
        match data_received["action"]:
            case "Change group":
                if data["isGroup"]:
                    """isGroup is True: Add to a multi-user room: #hi ....... """
    ...
    def send_html(self, event):
        """Event: Send the html to the client"""
        data = {
